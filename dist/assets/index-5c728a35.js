...
function zr(e, t, n, r, l) {
  ...
  if (((i = 0), (r = r === "" ? "." : r + ":"), Eu(e)))
    ...
    for (e = s.call(e), u = 0; !(o = e.next()).done; )
      (o = o.value), (s = r + Ql(o, u++)), (i += zr(o, t, n, s, l));
  else if (o === "object")
    throw (
      ((t = String(e)),
      Error(
...
O.StrictMode = Cf;
O.Suspense = Tf;
O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = jf;
 ...
 */ var If = Pt,
  ...
  Hf = If.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
 ...
 */ (function (e) {
      ...
      e: for (var Q = 0, q = C.length, pr = q >>> 1; Q < pr; ) {
        ...
        if (0 > l(Wl, T))
          Ct < q && 0 > l(hr, Wl)
            ? ((C[Q] = hr), (C[Ct] = T), (Q = Ct))
            : ((C[Q] = Wl), (C[xt] = T), (Q = xt));
        else if (Ct < q && 0 > l(hr, T)) (C[Q] = hr), (C[Ct] = T), (Q = Ct);
        else break e;
      }
    }
    return R;
  ...
  function x(C, R) {
    ...
    try {
      for (
        d(R), h = n(s);
        h !== null && (!(h.expirationTime > R) || (C && !Oe()));

      ) {
        var Q = h.callback;
        if (typeof Q == "function") {
          (h.callback = null), (m = h.priorityLevel);
          var q = Q(h.expirationTime <= R);
          (R = e.unstable_now()),
      ...
      if (h !== null) var pr = !0;
        ...
        var xt = n(a);
        xt !== null && Vl(S, xt.startTime - R), (pr = !1);
      }
      return pr;
    } finally {
      (h = null), (m = T), (w = !1);
      ...
      return (
        ...
        T > Q
          ? ((C.sortIndex = T),
            ...
            n(s) === null &&
              C === n(a) &&
              (g ? (f(P), (P = -1)) : (g = !0), Vl(S, T - Q)))
          : ((C.sortIndex = q), t(s, C), y || w || ((y = !0), Hl(x))),
        C
      );
    }),
...
function nd(e, t, n, r, l, o, i, u, s) {
  (Fn = !1), (Yr = null), ed.apply(td, arguments);
}
...
function ga(e) {
  return (e = ld(e)), e !== null ? wa(e) : null;
}
function wa(e) {
...
var je = Math.clz32 ? Math.clz32 : dd,
  cd = Math.log,
  fd = Math.LN2;
function dd(e) {
...
function Di(e, t, n, r) {
  if (br) {
    ...
    else if ((Du(e, r), t & 4 && -1 < yd.indexOf(e))) {
      for (; l !== null; ) {
        var o = ar(l);
        if (
          (o !== null && _a(o),
...
var mn = {
  ...
  ju = ke(El),
  kd = H({}, El, { dataTransfer: 0 }),
  xd = ke(kd),
  Cd = H({}, sr, { relatedTarget: 0 }),
  bl = ke(Cd),
  _d = H({}, mn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Nd = ke(_d),
  Pd = H({}, mn, {
...
var Fd = H({}, sr, {
  ...
  Id = ke(Md),
  Ud = H({}, mn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Bd = ke(Ud),
  $d = H({}, El, {
    deltaX: function (e) {
...
var Wd = qe && "TextEvent" in window && !An,
  ...
  if (qe) {
    ...
    if (!to) {
      ...
      Hu.setAttribute("oninput", "return;"),
        (to = typeof Hu.oninput == "function");
    }
    eo = to;
  } else eo = !1;
  ja = eo && (!document.documentMode || 9 < document.documentMode);
}
function Vu() {
...
function xl(e) {
  ...
  var t = Qt[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Ba) return (no[e] = t[n]);
  return e;
}
  ...
  if (!e[Cr]) {
    (e[Cr] = !0),
      ea.forEach(function (n) {
        n !== "selectionchange" && (op.has(n) || oo(n, !1, e), oo(n, !0, e));
      });
...
var Jo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  ap =
    typeof queueMicrotask == "function"
      ...
      : typeof qu < "u"
      ? function (e) {
          return qu.resolve(null).then(e).catch(cp);
        }
      : Jo;
function cp(e) {
  setTimeout(function () {
...
function rc(e) {
  ...
  function m(f, c, d, S) {
    ...
    if (typeof d == "object" && d !== null) {
      switch (d.$$typeof) {
        ...
        case lt:
          return (x = d._init), m(f, c, x(d._payload), S);
      }
  ...
  function g(f, c, d, S) {
    ...
    for (
      var _ = (x = null), N = c, P = (c = 0), W = null, L = d.next();
      N !== null && !L.done;
      P++, L = d.next()
    ) {
      N.index > P ? ((W = N), (N = null)) : (W = N.sibling);
    ...
    if (L.done) return n(f, N), U && _t(f, P), x;
    if (N === null) {
      for (; !L.done; P++, L = d.next())
        (L = h(f, L.value, S)),
          L !== null &&
            ((c = o(L, c, P)), _ === null ? (x = L) : (_.sibling = L), (_ = L));
      return U && _t(f, P), x;
    }
    ...
    if (
      ...
      switch (d.$$typeof) {
        ...
        case $t:
          ...
          return i(f);
        case lt:
          return (_ = d._init), z(f, c, _(d._payload), S);
      }
...
function qi(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Ir.current = e === null || e.memoizedState === null ? wp : Sp),
    (e = n(r, l)),
    In)
  ) {
    o = 0;
...
function Sc(e, t, n) {
  return At & 21
    ? (Ie(n, t) || ((n = xa()), ($.lanes |= n), (jt |= n), (e.baseState = !0)),
      t)
...
function jc(e) {
  ...
  t !== null && ((e.alternate = null), jc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[$e], delete t[Zn], delete t[Xo], delete t[fp], delete t[dp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Uc(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Le(t, e), Ue(e), r & 512 && n !== null && qt(n, n.return);
      break;
    case 5:
      if (
        (Le(t, e),
...
function ye(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && zu(n), t === 1))
      e.tag === 0 ? pp(Cs.bind(null, e)) : Ya(Cs.bind(null, e)),
        ap(function () {
          !(F & 6) && kt();
        }),
        (n = null);
...
function $c(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = yl(e, r);
    ...
    F |= 2;
    var o = Vc();
    (b !== e || ne !== t) && ((Qe = null), (dn = K() + 500), Lt(e, t));
    do
      try {
        Fp();
        break;
...
function uu() {
  (G === 0 || G === 3 || G === 2) && (G = 4),
    b === null || (!(jt & 268435455) && !(Tl & 268435455)) || ut(b, ne);
}
function yl(e, t) {
  var n = F;
  F |= 2;
...
function Nt(e, t, n) {
  var r = A,
    l = Ne.transition;
  try {
    (Ne.transition = null), (A = 1), Ap(e, t, n, r);
  } finally {
    (Ne.transition = l), (A = r);
  }
  return null;
...
ha = ou;
ma = Mt;
var Qp = { usingClientEntryPoint: !1, Events: [ar, Kt, Cl, da, pa, ou] },
  Pn = {
...
const Xp = ({ person: e }) => {
  const t = (n) => te.jsxs("button", { children: [" ", n.text] });
  return te.jsx("div", {
    children: te.jsxs("p", {
      children: [
        e.name,
        ...
        e.number,
        " ",
        te.jsx(t, { handleClick: e, text: "delete" }),
      ],
    }),
  });
};
...
const sh = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Os = "0123456789",
  uf = { DIGIT: Os, ALPHA: go, ALPHA_DIGIT: go + go.toUpperCase() + Os },
...
const Nh = (e) => {
  ...
  Ph = We("AsyncFunction"),
  Rh = (e) => e && (Ml(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  v = {
    isArray: vn,
    isArrayBuffer: ef,
    isBuffer: Gp,
...
function Il(e, t, n) {
  ...
  function p(y, g, z) {
    ...
    return yi(y) ? !0 : (t.append(Ls(z, g, o), a(y)), !1);
  }
  const h = [],
    m = Object.assign(Lh, {
      defaultVisitor: p,
...
const Ds = Dh,
  ...
  Ae = {
    isBrowser: !0,
    classes: { URLSearchParams: Fh, FormData: Ah, Blob: jh },
...
const Gh = Ae.isStandardBrowserEnv
  ? (function () {
      return {
...
const bh = Ae.isStandardBrowserEnv
  ? (function () {
...
const vi = { assertOptions: lm, validators: vu },
  rt = vi.validators;
class gl {
  constructor(t) {
    (this.defaults = t),
...
X.mergeConfig = pn;
X.AxiosHeaders = Ge;
X.formToJSON = (e) => hf(v.isHTMLForm(e) ? new FormData(e) : e);
X.getAdapter = vf.getAdapter;
X.HttpStatusCode = sm;
X.default = X;
const Bl = X,
  $l = "/api/persons",
  am = () => Bl.get($l).then((t) => t.data),
  cm = (e) => Bl.post($l, e).then((n) => n.data),
  fm = (e, t) => Bl.put(`${$l}/${e}`, t).then((r) => r.data),
  dm = (e, t) => Bl.delete(`${$l}/${e}`, t).then((r) => r.data),
  Us = { getAll: am, create: cm, update: fm, remove: dm },
  pm = () => {
    ...
    const i = (a) => {
        a.preventDefault();
        const p = { name: n, number: l, id: e.length + 1 };
        e.some((m) => m.name === p.name)
          ? alert(`${n} is already added to phonebook`)
          : Us.create(p).then((m) => {
              console.log(m), console.log(e), t(e.concat(m));
            }),
          r(""),
          o("");
      },
    ...
    return te.jsxs("div", {
      children: [
        te.jsx("h2", { children: "Phonebook" }),
        te.jsxs("form", {
          onSubmit: i,
          children: [
            te.jsxs("div", {
              children: ["name: ", te.jsx("input", { value: n, onChange: u })],
            }),
            te.jsxs("div", {
              children: [
                "number: ",
                te.jsx("input", { value: l, onChange: s }),
              ],
            }),
            te.jsx("div", {
              children: te.jsx("button", { type: "submit", children: "add" }),
            }),
          ],
        }),
        te.jsx("h2", { children: "Numbers" }),
        e.map((a) => te.jsx(Xp, { person: a }, a.id)),
      ],
    });
  };
ko.createRoot(document.getElementById("root")).render(
  te.jsx(Mf.StrictMode, { children: te.jsx(pm, {}) })
);
